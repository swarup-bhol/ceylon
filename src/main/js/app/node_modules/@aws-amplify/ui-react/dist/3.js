...
/* harmony import */ var _helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers-9703fe65.js */ "../amplify-ui-components/dist/esm-es5/helpers-9703fe65.js");
/* harmony import */ var _auth_helpers_475f7fa4_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth-helpers-475f7fa4.js */ "../amplify-ui-components/dist/esm-es5/auth-helpers-475f7fa4.js");
...
var AmplifyConfirmSignIn = function () {
  function class_1(hostRef) {
    ...
    this.handleAuthStateChange = _helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["d"];
    /** Default form field */
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_475f7fa4_js__WEBPACK_IMPORTED_MODULE_7__["c"])(this.user, this.handleAuthStateChange)];
          ...
          case 4:
            error_1 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_1);
            return [3
            /*break*/
            , 6];
...
var AmplifyConfirmSignUp = function () {
  ...
  class_2.prototype.setup = function () {
    ...
    Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["c"])(this.usernameAlias);
    this.buildFormFields();
  };
  ...
  class_2.prototype.handleFormFieldInputChange = function (fieldType) {
    ...
    switch (fieldType) {
      ...
      case 'phone_number':
        return function (event) {
          return Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["h"])(event, _this.phoneNumber);
        };
  ...
  class_2.prototype.getUsername = function () {
    ...
    switch (this.usernameAlias) {
      ...
      case 'phone_number':
        return Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
    }
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_2 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_2);
            return [3
            /*break*/
            , 4];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_475f7fa4_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this._signUpAttrs.password, this.handleAuthStateChange)];
          ...
          case 6:
            error_3 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_3);
            return [3
            /*break*/
            , 8];
        ...
        switch (_a.label) {
          case 0:
            ...
            switch (this.usernameAlias) {
              case 'phone_number':
                try {
                  this.forgotPasswordAttrs.userInput = Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
                } catch (error) {
                  Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
                }
          ...
          case 3:
            error_4 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_4);
            return [3
            /*break*/
            , 5];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            error_5 = _b.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_5);
            return [3
            /*break*/
            , 5];
...
var AmplifyRequireNewPassword = function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_6 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_6);
            return [3
            /*break*/
            , 4];
          ...
          case 6:
            if (this.currentUser && this.currentUser.challengeParam && this.currentUser.challengeParam.requiredAttributes) {
              ...
              requiredAttributesMap_1 = Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["g"])();
  ...
  class_4.prototype.formatPhoneNumber = function (event) {
    Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["h"])(event, this.phoneNumber);
    /**
    ...
    try {
      if (event.target.name === _constants_c8ecaa24_js__WEBPACK_IMPORTED_MODULE_5__["b"] && this.phoneNumber.phoneNumberValue) {
        var composedInput = Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            return [4
            /*yield*/
            , Object(_auth_helpers_475f7fa4_js__WEBPACK_IMPORTED_MODULE_7__["c"])(user, this.handleAuthStateChange)];
          ...
          case 8:
            error_7 = _b.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_7);
            return [3
            /*break*/
            , 10];
        ...
        switch (_a.label) {
          case 0:
            ...
            switch (this.usernameAlias) {
              case 'phone_number':
                try {
                  this.signInAttributes.userInput = Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
                } catch (error) {
                  Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
                }
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_475f7fa4_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this.signInAttributes.password, this.handleAuthStateChange, this.usernameAlias)];
...
var AmplifySignUp = function () {
  ...
  class_6.prototype.assignPhoneNumberToSignUpAttributes = function () {
    if (this.phoneNumber.phoneNumberValue) {
      try {
        this.signUpAttributes.attributes.phone_number = Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
      } catch (error) {
        Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
      }
    }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , Object(_auth_helpers_475f7fa4_js__WEBPACK_IMPORTED_MODULE_7__["h"])(this.signUpAttributes.username, this.signUpAttributes.password, this.handleAuthStateChange)];
          ...
          case 6:
            error_8 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_8);
            return [3
            /*break*/
            , 8];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_9 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_9);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_10 = _a.sent();
            Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error_10);
...
/***/ "../amplify-ui-components/dist/esm-es5/auth-helpers-475f7fa4.js":
/*!**********************************************************************!*\
  !*** ../amplify-ui-components/dist/esm-es5/auth-helpers-475f7fa4.js ***!
  \**********************************************************************/
...
/* harmony import */ var _helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers-9703fe65.js */ "../amplify-ui-components/dist/esm-es5/helpers-9703fe65.js");
var __awaiter = undefined && undefined.__awaiter || function (thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function (resolve) {
      resolve(value);
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          error_1 = _a.sent();
          Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_5__["a"])(error_1);
          return [3
          /*break*/
          , 4];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 9:
          ...
          Object(_helpers_9703fe65_js__WEBPACK_IMPORTED_MODULE_5__["a"])(error_2);
          return [3
          /*break*/
          , 10];
